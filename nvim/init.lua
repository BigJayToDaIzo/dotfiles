...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- TODO: Abstract these keybinds into keymaps.lua
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Yoinked <leader>c for Copilot Chat
  ...
  -- Autocompletion handled in /lua/custom/plugins/autocomplete.lua
  ...
  -- TODO: Abstract away the configuration of mini.nvim into a separate file
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'go', 'rust' },
  ...
  { -- Context bar for cursor location
